...
public class UniversalImageLoader implements Html.ImageGetter {
    Context c;
    TextView container;
     ...
     * @param c
     */
    public UniversalImageLoader(View t, Context c) {
        this.c = c;
    ...
    public Drawable getDrawable(String source) {
        ...
        urlDrawable.drawable = c.getResources().getDrawable(R.drawable.default_image);
